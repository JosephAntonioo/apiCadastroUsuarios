package digital.innovation.one.apiCadastroUsuarios.mapper;
...
import digital.innovation.one.apiCadastroUsuarios.utils.PersonUtils;
...
public class PersonMapperTest {
    ...
    void testGivenPersonDTOThenReturnPersonEntity() {
        ...
        PhoneModel phone = person.getPhones().get(0);
    ...
    void testGivenPersonEntityThenReturnPersonDTO() {
        PersonModel person = PersonUtils.createFakeEntity();
